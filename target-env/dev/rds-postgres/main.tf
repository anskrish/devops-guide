...
module "db_subnet_group" {
  source = "../../../../modules/rds-postgres/db_subnet_group/."
...
module "db_parameter_group" {
  source = "../../../../modules/rds-postgres/db_parameter_group/."
...
module "db_option_group" {
  source = "../../../../modules/rds-postgres/db_option_group/."
...
module "db_instance" {
  source = "../../../../modules/rds-postgres//db_instance/."
